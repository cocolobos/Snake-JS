...
(function (window, undefined) {
    ...
    function init() {
        ...
        wall.push(new Rectangle(150, 50, 10, 10));
        wall.push(new Rectangle(150, 100, 10, 10));
    ...
    gameScene.act = function () {
        ...
        if (!pause) {
            ...
            if (body[0].intersects(special)) {
                setTimeout(function specialFood(){
                    special.y = random(canvas.height / 10 - 1) * 10;
                    special.x = random(canvas.width / 10 - 1) * 10;
                },5000);
                score += 3;
                aEat.play();
                special.x = -10;
